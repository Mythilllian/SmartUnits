...
class Velocity(Measure["VelocityUnit[D]"], ABC, Generic[D]):
    ...
    @override
    def into(self, unit: "VelocityUnit[D]") -> "VelocityUnit[D]":
        if unit is self._unit:
            return self._magnitude
        return "VelocityUnit[D]".of(unit.from_base_units(self._base_unit_magnitude))

    @override
    def in_unit(self, unit: "VelocityUnit[D]") -> float:
        if unit is self._unit:
            return self._magnitude

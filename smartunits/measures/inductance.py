...
if TYPE_CHECKING:
        from smartunits import InductanceUnit 

@dataclass(frozen=True, slots=True)
class Inductance(Measure["InductanceUnit"], ABC):
    _magnitude: float
    _base_unit_magnitude: float
    _unit: "InductanceUnit"

    @staticmethod
    def of(magnitude: float, unit: "InductanceUnit") -> "Inductance":
        return Inductance(magnitude, unit.to_base_units(magnitude), unit)

    @staticmethod
    def of_base_units(base_unit_magnitude: float, unit: "InductanceUnit") -> "Inductance":
        return Inductance(unit.from_base_units(base_unit_magnitude), base_unit_magnitude, unit)
    ...
    @override
    def unit(self) -> "InductanceUnit":
        return self._unit

    @override
    def base_unit(self) -> "InductanceUnit":
        return self._unit._base_unit

    @override
    def into(self, unit: "InductanceUnit") -> "InductanceUnit":
        if unit is self._unit:
            return self._magnitude
        return "InductanceUnit".of(unit.from_base_units(self._base_unit_magnitude))

    @override
    def in_unit(self, unit: "InductanceUnit") -> float:
        if unit is self._unit:
            return self._magnitude
        return unit.from_base_units(self._base_unit_magnitude)

    @override
    def in_units(self, unit: "InductanceUnit") -> float:
        if unit is self._unit:
            return self._magnitude
        return unit.from_base_units(self._base_unit_magnitude)
    
    @override
    def __neg__(self) -> "Inductance":
        return Inductance(-self._magnitude, -self._base_unit_magnitude, self._unit)
    
    @override
    def __add__(self, other: Measure["InductanceUnit"]) -> "Inductance":
        if self._unit is other._unit:
            return Inductance(self._magnitude + other._magnitude, self._base_unit_magnitude + other._magnitude, self._unit)
        
        return self._unit.of_base_units(self._base_unit_magnitude + other._base_unit_magnitude)
    
    @override
    def __sub__(self, other: Measure["InductanceUnit"]) -> "Inductance":
        if self._unit is other._unit:
            return Inductance(self._magnitude - other._magnitude, self._base_unit_magnitude, self._unit)
    ...
    def __mul__(self, other: Any) -> Measure[Any]:
        ...
        if isinstance(other, (int, float)):
                return Inductance(self._magnitude * other, self._base_unit_magnitude * other, self._unit)
        ...
        if isinstance(other, Dimensionless):
                ...
                return Inductance(self._magnitude * factor, self._base_unit_magnitude * factor, self._unit)

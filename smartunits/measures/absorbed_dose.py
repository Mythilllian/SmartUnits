...
if TYPE_CHECKING:
        from smartunits import AbsorbedDoseUnit 

@dataclass(frozen=True, slots=True)
class AbsorbedDose(Measure["AbsorbedDoseUnit"], ABC):
    _magnitude: float
    _base_unit_magnitude: float
    _unit: "AbsorbedDoseUnit"

    @staticmethod
    def of(magnitude: float, unit: "AbsorbedDoseUnit") -> "AbsorbedDose":
        return AbsorbedDose(magnitude, unit.to_base_units(magnitude), unit)

    @staticmethod
    def of_base_units(base_unit_magnitude: float, unit: "AbsorbedDoseUnit") -> "AbsorbedDose":
        return AbsorbedDose(unit.from_base_units(base_unit_magnitude), base_unit_magnitude, unit)
    ...
    @override
    def unit(self) -> "AbsorbedDoseUnit":
        return self._unit
    ...
    @override
    def __neg__(self) -> "AbsorbedDose":
        return AbsorbedDose(-self._magnitude, -self._base_unit_magnitude, self._unit)
    
    @override
    def __add__(self, other: Measure["AbsorbedDoseUnit"]) -> "AbsorbedDose":
        if self._unit is other._unit:
            return AbsorbedDose(self._magnitude + other._magnitude, self._base_unit_magnitude + other._magnitude, self._unit)
        
        return self._unit.of_base_units(self._base_unit_magnitude + other._base_unit_magnitude)
    
    @override
    def __sub__(self, other: Measure["AbsorbedDoseUnit"]) -> "AbsorbedDose":
        if self._unit is other._unit:
            return AbsorbedDose(self._magnitude - other._magnitude, self._base_unit_magnitude, self._unit)
    ...
    def __mul__(self, other: Any) -> Measure[Any]:
        ...
        if isinstance(other, (int, float)):
                return AbsorbedDose(self._magnitude * other, self._base_unit_magnitude * other, self._unit)

        # handles AbsorbedDose
        if isinstance(other, AbsorbedDose):
        ...
        if isinstance(other, Dimensionless):
                ...
                return AbsorbedDose(self._magnitude * factor, self._base_unit_magnitude * factor, self._unit)

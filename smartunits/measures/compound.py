...
class Compound(Measure["CompoundUnit"], ABC):
    ...
    @override
    def into(self, unit: "CompoundUnit") -> "CompoundUnit":
        if unit is self._unit:
            return self._magnitude
        return "CompoundUnit".of(unit.from_base_units(self._base_unit_magnitude))

    @override
    def in_unit(self, unit: "CompoundUnit") -> float:
        if unit is self._unit:
            return self._magnitude

...
class AngularVelocity(Measure["AngularVelocityUnit"], ABC):
    ...
    @override
    def into(self, unit: "AngularVelocityUnit") -> "AngularVelocityUnit":
        if unit is self._unit:
            return self._magnitude
        return "AngularVelocityUnit".of(unit.from_base_units(self._base_unit_magnitude))

    @override
    def in_unit(self, unit: "AngularVelocityUnit") -> float:
        if unit is self._unit:
            return self._magnitude

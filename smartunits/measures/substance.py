...
if TYPE_CHECKING:
        from smartunits import SubstanceUnit 

@dataclass(frozen=True, slots=True)
class Substance(Measure["SubstanceUnit"], ABC):
    _magnitude: float
    _base_unit_magnitude: float
    _unit: "SubstanceUnit"

    @staticmethod
    def of(magnitude: float, unit: "SubstanceUnit") -> "Substance":
        return Substance(magnitude, unit.to_base_units(magnitude), unit)

    @staticmethod
    def of_base_units(base_unit_magnitude: float, unit: "SubstanceUnit") -> "Substance":
        return Substance(unit.from_base_units(base_unit_magnitude), base_unit_magnitude, unit)
    ...
    @override
    def __neg__(self) -> "Substance":
        return Substance(-self._magnitude, -self._base_unit_magnitude, self._unit)
    
    @override
    def __add__(self, other: Measure["SubstanceUnit"]) -> "Substance":
        if self._unit is other._unit:
            return Substance(self._magnitude + other._magnitude, self._base_unit_magnitude + other._magnitude, self._unit)
        
        return self._unit.of_base_units(self._base_unit_magnitude + other._base_unit_magnitude)
    
    @override
    def __sub__(self, other: Measure["SubstanceUnit"]) -> "Substance":
        if self._unit is other._unit:
            return Substance(self._magnitude - other._magnitude, self._base_unit_magnitude, self._unit)
    ...
    def __mul__(self, other: Any) -> Measure[Any]:
        ...
        if isinstance(other, (int, float)):
                return Substance(self._magnitude * other, self._base_unit_magnitude * other, self._unit)
        ...
        if isinstance(other, Dimensionless):
                ...
                return Substance(self._magnitude * factor, self._base_unit_magnitude * factor, self._unit)
